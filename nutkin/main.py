...
def main():
    ...
    data_pre = preprocess_adata(
            adata,n_comps=args.n_comps,
            save_scree_plot=args.save_scree_plot,skip_preprocessing=args.skip_preprocessing,output_path=args.output_path)
    plot_embedding(data_pre,method=args.embedding_method,color=args.color,use_rep=args.use_rep,
    save_embedding_plot=args.save_embedding_plot,output_path=args.output_path)
    ...
    processor.visualize_pca_results(detail=args.detail,plot_pc_num=args.plot_pc_num)
